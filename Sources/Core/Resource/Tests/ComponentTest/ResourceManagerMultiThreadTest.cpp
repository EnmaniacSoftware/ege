...
//--------------------------------------------------------------------------------------------------------------------------------------------------------------
TEST_F(ResourceManagerMultiThreadTest, AddResourcesInvalidDataDirectory)
{
...
//--------------------------------------------------------------------------------------------------------------------------------------------------------------
TEST_F(ResourceManagerMultiThreadTest, LoadAnotherDuringLoadComplete)
{
  // setup resource factory
  std::vector<ResourceMock*> resources = setupResourceFactory();
...
//--------------------------------------------------------------------------------------------------------------------------------------------------------------
TEST_F(ResourceManagerMultiThreadTest, UnloadDuringLoadComplete)
{
  // setup resource factory
  std::vector<ResourceMock*> resources = setupResourceFactory();
...
//--------------------------------------------------------------------------------------------------------------------------------------------------------------
TEST_F(ResourceManagerMultiThreadTest, LoadAnotherDuringUnloadComplete)
{
  // setup resource factory
  std::vector<ResourceMock*> resources = setupResourceFactory();
...
//--------------------------------------------------------------------------------------------------------------------------------------------------------------
TEST_F(ResourceManagerMultiThreadTest, UnloadAnotherDuringUnloadComplete)
{
  // setup resource factory
  std::vector<ResourceMock*> resources = setupResourceFactory();
...
//--------------------------------------------------------------------------------------------------------------------------------------------------------------
TEST_F(ResourceManagerMultiThreadTest, LoadAnotherDuringLoadingProgress)
{
  // setup resource factory
  std::vector<ResourceMock*> resources = setupResourceFactory();
...
//--------------------------------------------------------------------------------------------------------------------------------------------------------------
TEST_F(ResourceManagerMultiThreadTest, UnloadAnotherDuringLoadingProgress)
{
  // setup resource factory
  std::vector<ResourceMock*> resources = setupResourceFactory();
