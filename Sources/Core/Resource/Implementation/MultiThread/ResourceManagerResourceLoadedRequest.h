#ifndef EGE_CORE_RESOURCE_MULTITHREAD_RESOURCEMANAGERRESOURCELOADEDREQUEST_H
#define EGE_CORE_RESOURCE_MULTITHREAD_RESOURCEMANAGERRESOURCELOADEDREQUEST_H
...
//--------------------------------------------------------------------------------------------------------------------------------------------------------------
class ResourceManagerResourceLoadedRequest : public ResourceManagerRequest
{
  public:

    ResourceManagerResourceLoadedRequest(const PResource& resource, EGEResult result, s32 count, s32 total) 
    : m_resource(resource)
    , m_result(result)
  ...
  private:
    ...
    RequestType type() const override { return EResourceLoaded; }
...
#endif // EGE_CORE_RESOURCE_MULTITHREAD_RESOURCEMANAGERRESOURCELOADEDREQUEST_H