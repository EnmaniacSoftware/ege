...
class Viewport : public Object
{
  public:
    ...
    BufferType clearBufferTypes() const
    {
        return m_clearBufferTypes;
    }
  ...
  private:
    ...
    bool m_overlays;
    /*! Raw pointer (no need to keep smart one as each viewport is owned by target) to render target, viewport belongs
     * to. */
