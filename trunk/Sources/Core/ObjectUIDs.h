...
#define EGE_OBJECT_UID_VERTEX_BUFFER          ((EGE_CORE_GRAPHICS_OBJECT_UID_BASE + 8))
#define EGE_OBJECT_UID_HARDWARE_VERTEX_BUFFER ((EGE_CORE_GRAPHICS_OBJECT_UID_BASE + 9))
