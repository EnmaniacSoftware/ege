...
void TextOverlay::updateRenderData()
{
  ...
  renderData()->vertexBuffer()->setSize(text().length() * 6);
...
void TextOverlay::initialize()
{
  ...
  m_renderData  = RenderObjectFactory::CreateQuadXY(app(), "overlay-" + name(), Vector4f::ZERO, Vector2f::ONE, EGEAlignment::ALIGN_TOP_LEFT, 
