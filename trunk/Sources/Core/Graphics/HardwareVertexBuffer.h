#ifndef EGE_CORE_HARDWAREVERTEXBUFFER_H
#define EGE_CORE_HARDWAREVERTEXBUFFER_H

/** 
 *   HardwareVertexBuffer base class.
 */
...
EGE_DECLARE_SMART_CLASS(HardwareVertexBuffer, PHardwareVertexBuffer)
...
class HardwareVertexBuffer : public VertexBuffer
{
  public:
    ...
    HardwareVertexBuffer(Application* app, EGEVertexBuffer::UsageType usage);
...
#endif // EGE_CORE_HARDWAREVERTEXBUFFER_H
